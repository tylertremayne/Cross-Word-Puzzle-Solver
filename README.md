in the current version of "word-search-puzzle-solver"

1. it is required that you manually type the contents of your word search (scannable word search coming soon)
